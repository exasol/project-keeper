 ...
 */
public class DependencyUpdate extends DependencyChange {
    private final String newVersion;

    /**
     * Create a new instance of {@link DependencyUpdate}.
     * 
     ...
     */
    protected DependencyUpdate(final String groupId, final String artifactId, final String version,
    ...
    public boolean equals(final Object other) {
        ...
        if (!super.equals(other))
            return false;
        final DependencyUpdate that = (DependencyUpdate) other;

...
class ReproducibleBuildPluginValidatorTest extends AbstractMavenPluginPomValidatorTestBase {

    ReproducibleBuildPluginValidatorTest() {
        super(new ReproducibleBuildPluginValidator());
    }

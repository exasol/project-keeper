...
/**
 * Simplified {@link MavenFileProjectReader} that works without injected dependencies.
 */
public class SimpleMavenFileProjectReader implements MavenFileProjectReader {
    @Override

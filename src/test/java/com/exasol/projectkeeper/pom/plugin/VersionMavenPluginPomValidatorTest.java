...
class VersionMavenPluginPomValidatorTest extends AbstractMavenPluginPomValidatorTest {
    ...
    @CsvSource({ //
            "configuration, The versions-maven-plugin's configuration does not contain the required property configuration/rulesUri.", //
            "configuration/rulesUri, The versions-maven-plugin's configuration does not contain the required property configuration/rulesUri.", //
            "configuration/rulesUri/text(), The versions-maven-plugin's configuration-property configuration/rulesUri has an illegal value."//
    })
    @ParameterizedTest

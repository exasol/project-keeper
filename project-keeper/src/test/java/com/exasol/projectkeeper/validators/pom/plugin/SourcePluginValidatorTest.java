...
class SourcePluginValidatorTest extends AbstractMavenPluginPomValidatorTestBase {

    SourcePluginValidatorTest() {
        super(new SourcePluginValidator());
    }

    @ValueSource(strings = { "executions", "executions/execution", "executions/execution/goals" })
    @ParameterizedTest

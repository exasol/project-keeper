...
public class PomFileGenerator {
    ...
    public String generatePomContent(final Collection<ProjectKeeperModule> enabledModules, final String groupId,
            ...
            final String repoName, final String licenseName) {
    ...
    private Element buildProject(final Collection<ProjectKeeperModule> enabledModules, final String groupId,
            ...
            final ProjectKeeperConfig.ParentPomRef parentPomRef, final String repoName, final String licenseName) {
        ...
        project.appendChild(buildLicensesTag(document, repoName, licenseName));
        project.appendChild(buildDevelopersTag(document));
        project.appendChild(buildScmTag(document, repoName));
        project.appendChild(buildDependencies(enabledModules, document));
        project.appendChild(buildBuild(enabledModules, document));
        return project;
    }

    private Element buildLicensesTag(final Document document, final String repoName, final String licenseName) {
        final Element licenses = document.createElement("licenses");
        final Element license = document.createElement("license");
        addTextElement(license, "name", licenseName);
        // todo add branch name?
        addTextElement(license, "url", "https://github.com/exasol/" + repoName + "/blob/main/LICENSE");

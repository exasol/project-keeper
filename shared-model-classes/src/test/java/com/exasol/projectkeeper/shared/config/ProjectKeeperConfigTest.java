...
class ProjectKeeperConfigTest {
    ...
    void createConfig() {
        final ProjectKeeperConfig config = ProjectKeeperConfig.builder()
                ...
                .versionConfig(new ProjectKeeperConfig.VersionFromSource(Paths.get("version-pom.xml"))).build();
        assertAll(() -> assertThat(config.getExcludes(), contains("exclude1")),
                ...
                () -> assertThat(config.getSources().get(0).getPath(), equalTo(Paths.get("pom.xml"))),
    ...
    void versionFromSourceAcceptsVisitor() {
        ...
        final VersionFromSource version = new ProjectKeeperConfig.VersionFromSource(Paths.get("pom.xml"));
